...
|A0（1）|A1（2）|A2（3）|A0（1）|A1（2）|A2（3）|A0（1）|A1（2）|
|-|-|-|-|-|-|-|-|
|A2（3）|
|0（OFF）|0（OFF）|0（OFF）|1（ON）|0（OFF）|0（OFF）|0（OFF）|1（ON）|
|0（OFF）|
|OX70|
|OX71|
|OX72||
|A0（1）|A1（2）|A2（3）|A0（1）|A1（2）|A2（3）|A0（1）|A1（2）|
|A2（3）|
|1（ON）|1（ON）|0（OFF）|0（OFF）|0（OFF）|1（ON）|1（ON）|0（OFF）|
|1（ON）|
|OX73|
|OX74|
|OX75||
...
1.  设置时，我们参考本章节实验三十方法。利用按键中断计算出按下按键的次数，除以5，得到余数，为0     1 2 3 4 ，根据不同的余数，构造5个独一的函数来控制实验实现不同功能。
